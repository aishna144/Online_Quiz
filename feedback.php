...
<a href="index.php" class="pull-right btn logb btn-primary" style="color:white"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;<font style="font-size:12px;font-weight:bold">Feedback</font></a>&nbsp;
</div></div>
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="username" name="username" placeholder="Enter your Registration Number" class="form-control input-md" type="username">
...
<div class="row">
<div class="col-md-3"><b>Name:</b><br /><br /><br /><b>Course Name:</b></div>
<div class="col-md-9">
<!-- Text input-->
<div class="form-group">
  <input id="name" name="name" placeholder="Enter Your Name" class="form-control input-md" type="text"><br />    
   <input id="name" name="subject" placeholder="Enter Your Course Name" class="form-control input-md" type="text">    
...
<span href="#" data-target="#login" style="color:lightyellow">Developed and Managed by VITians<br><br></span></div>
