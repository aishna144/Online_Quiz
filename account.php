...
if (@$_GET['q'] == 3)
    echo 'class="active"';
?>><a href="account.php?q=3"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;Class Leaderboard</a></li></ul>
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Course Name</b></td><td style="vertical-align:middle"><b>Total Questions</b></td><td style="vertical-align:middle"><b>Marks for Correct Answer</b></td><td style="vertical-align:middle"><b>Marks for Wrong Answers</b></td><td style="vertical-align:middle"><b>Maximum Marks for the Quiz</b></td><td style="vertical-align:middle"><b>Time limit</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
    $c = 1;
...
<center><h1 class="title" style="color:#660033">Result</h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
    ...
    <tr style="color:darkblue"><td style="vertical-align:middle">Score&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $s . '</td></tr>';
        ...
        die("That's a 404 Error. You are trying to access a wrong page");
    }
}
if (@$_GET['q'] == 2) {
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Course Name</b></td><td style="vertical-align:middle"><b>Total Number of Questions</b></td><td style="vertical-align:middle"><b>Number of Right Answers</b></td><td style="vertical-align:middle"><b>Number of Wrong Answers<b></td><td style="vertical-align:middle"><b>Number of Unattempted Questions<b></td><td style="vertical-align:middle"><b>Total Score</b></td><td style="vertical-align:middle"><b>Action<b></td></tr>';
    $c = 0;
    while ($row = mysqli_fetch_array($q)) {
        $eid = $row['eid'];
        $s   = $row['score'];
...
if (@$_GET['q'] == 3) {
    ...
    echo '<div class="panel title">
<table class="table table-striped title1" >
<tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Student Name</b></td><td style="vertical-align:middle"><b>Student Branch</b></td><td style="vertical-align:middle"><b>Registration Number</b></td><td style="vertical-align:middle"><b>Total Score</b></td></tr>';
    $c = $showfrom-1;
...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:blue;" onmouseover="this.style('color:black')" target="new">Developed and Managed by VITians</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">VITians</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="Logo.png" width=100 height=100 alt="VIT" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Darshan, Rohan, Aishna & Palak</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 8999004656</h4>
		<h4 style="font-family:'typo' ">VITians@vitstudent.ac.in</h4>
...
<a href="feedback.php" style="color:blue;text-decoration:underline" onmouseover="this.style('color:black')" target="new">Feedback</a></div>
